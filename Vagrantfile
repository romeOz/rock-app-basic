...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
    ...
    config.vm.synced_folder "./", "/var/www/rock-basic"
    ...
    config.vm.provider "virtualbox" do |vb|
        ...
        vb.customize ["modifyvm", :id, "--name", "rock-basic"]
    ...
    if Vagrant.has_plugin?("vagrant-hostsupdater")
        ...
        config.vm.hostname = "rock-basic"
        config.hostsupdater.aliases = ["www.rock-basic"]
    end
